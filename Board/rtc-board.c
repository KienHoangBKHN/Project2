 ...
 * \file      rtc-board.c
 *
 * \brief     Target board RTC timer and low power modes management: duoc chinh sua phu hop voi stm32f103rctx
 *
...
// chu y ham nay mot chut (Kien Hoang- 10/04/2018)
void RtcEnterLowPowerStopMode( void )
{
    if( ( LowPowerDisableDuringTask == false ) && ( RtcTimerEventAllowsLowPower == true ) )
    {
        //BoardDeInitMcu( );
				BoardInit(); // khoi tao lai Mcu
...
void RtcRecoverMcuStatus( void )
{
    ...
    */
		if(((__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_HSE)) || (__HAL_RCC_GET_SYSCLK_SOURCE() == RCC_SYSCLKSOURCE_STATUS_HSI))
		{
        // BoardInitMcu( );
				BoardInit();
    }
